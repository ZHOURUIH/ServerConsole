#ifndef _SHARE_MEMORY_SERVER_H_
#define _SHARE_MEMORY_SERVER_H_
...
#define DEFAULT_MAPNAME  "Local//_MAP_"   // 默認的共享內存名
...
public:
	ShareMemoryServer();
	virtual ~ShareMemoryServer();
	ShareMemoryServer(char *szFileName, char *szMapName, DWORD dwSize);
